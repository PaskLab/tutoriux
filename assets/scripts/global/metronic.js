...
module.exports = function() {
    ...
    var handlePortletTools = function() {
        ...
        $(document).on('keyup', function(e){
            if (e.keyCode == 27) {
                ...
                if (portlet) {
                    var button = portlet.find('.fullscreen');
    ...
    var initSlimScroll = function(el) {
        $(el).each(function() {
            ...
            $(this).slimScroll({
                allowPageScroll: false, // do not allow page scroll when the element scroll is ended
                size: '7px',
    ...
    var setAssetsPath = function(path) {
        assetsPath = path;
    };
    ...
    return {
        ...
        setGlobalImgPath: setGlobalImgPath,

        getGlobalImgPath: getGlobalImgPath
    };
